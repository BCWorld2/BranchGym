...
function InitializeFileDragAndDrop() {
    // Original Line: nodes = window.parent.document.querySelectorAll('div[controlname="FDD Drag & Drop Factbox"]'); //find all controls by page name
    nodes = window.parent.document.querySelectorAll('div[controlname="IncDocAttachDragAndDropArea"]'); //find all controls by page name
...
function uploadFile(file, i) {
    ...
    reader.addEventListener("loadend", function() {
        ...
        Microsoft.Dynamics.NAV.InvokeExtensibilityMethod('OnFileUpload',[file.name,base64data,filesCount == (i + 1), filesCount]);
     });
